...
import (
	...
	"github.com/behzade/zerolang/compiler/token"
)
...
// Statement is a subtype of Node that represents a statement.
type Statement interface {
	Node
	statementNode()
}

// Expression is a subtype of Node that represents an expression.
