...
impl Typechecker {
    pub(crate) fn is_numeric_type(&self, ty: &hir::Ty) -> bool {
        matches!(ty, hir::Ty::Primitive(hir::PrimitiveTy::I32) | hir::Ty::Primitive(hir::PrimitiveTy::I64) | hir::Ty::Primitive(hir::PrimitiveTy::F64))
    }

    pub(crate) fn is_numeric_literal(&self, lit: &crate::ast_owned::OwnedLiteral) -> bool {
        matches!(lit, crate::ast_owned::OwnedLiteral::I32(_) | crate::ast_owned::OwnedLiteral::I64(_) | crate::ast_owned::OwnedLiteral::F64(_))
    }
    ...
    pub(crate) fn coerce_numeric_literal(&self, lit: &crate::ast_owned::OwnedLiteral, expected: hir::PrimitiveTy) -> Option<(hir::PrimitiveTy, String)> {
        use hir::PrimitiveTy::*;
        match (lit, expected) {
